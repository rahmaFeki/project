            ...
            <div class="container-fluid">
				...
				<span id="rep" ></span>
				 ...
				 @csrf
						...
						<td><a href="" class="btn btn-icon btn-sm" title="Edit"  data-toggle="modal" data-target="#exampleModal" onClick="initi({!! $u->id!!} , '{!! $u->lib!!}')"><i class="fa fa-edit"></i></a>
						<button type="button" class="btn btn-icon btn-sm js-sweetalert" title="Delete" data-type="confirm" onClick="supp({!! $u->id!!})" ><i class="fa fa-trash-o text-danger"></i></button>
						</td>
						</tr>
...
$('#exampleModal').on('shown.bs.modal', function (e) {
 ...
 $("#add").click(function(event){
  ...
  position: 'center',
  icon: 'success',
  title: 'Choix est ajouté avec succès',
...
location.reload();
					Swal.fire(
						'Supprimé!',
						'Choix est supprimé avec succès.',
						'success',
