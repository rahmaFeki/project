...
<div class="page">
    ...
    <div class="section-body mt-4">
      ...
      <a href="#" onClick="supp(<?php echo $g->id; ?>)" class="card-options-remove" data-toggle="card-remove"><i class="fe fe-x"></i></a>
                            </div>
                                                </div>
...
$('#upload-image-form').submit(function(e) {
    ...
    $.ajax({
        url: "<?php echo e(route('ajouter.image')); ?>",
        headers: {
...
function supp(index) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: "<?php echo e(route('delete.gallery')); ?>",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
                type: 'post',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\msm\resources\views/gestion_gallery.blade.php ENDPATH**/ ?>