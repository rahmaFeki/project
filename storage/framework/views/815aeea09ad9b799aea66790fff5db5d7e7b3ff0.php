                                                ...
                                                <div class="row clearfix">
                                                    <div class="col-md-6 col-sm-12">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <?php if(isset($entre->nom)): ?>
                                                            <input type="text" class="form-control" id="nom" name="nom"
                                                                value="<?php echo $entre->nom; ?>" />
                                                            <?php else: ?>
                                                            <input type="text" class="form-control" id="nom" name="nom"
                                                                value="" />
                                                            <?php endif; ?>
                                                    ...
                                                    <div class="col-md-6 col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="email"
                                                                name="adresse" value="<?php echo $entre->email; ?>" />
                                                            <?php else: ?>
                                                            <input type="text" class="form-control" id="email"
                                                                value="" />
                                                            <?php endif; ?>
                                                    ...
                                                    <div class="col-md-12 col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="adr"
                                                                name="prenom" value="<?php echo $entre->adr; ?>" />
                                                            <?php else: ?>
                                                    ...
                                                    <div class="col-md-12 col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea id="contenu" class="form-control" rows="4"
                                                                cols="33"><?php echo $entre->contenu; ?></textarea>
                                                            <?php else: ?>
...
$("#edit").click(function(event) {
    ...
    if ($id != '6') {
        //$confirm=$("#confirm").val();
        $.ajax({
            url: "<?php echo e(route('ajouter.entrep')); ?>",
            headers: {
        ...
        $.ajax({
            url: "<?php echo e(route('update.entrep')); ?>",
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            },
            type: "POST",
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\msm\resources\views/entreprise.blade.php ENDPATH**/ ?>