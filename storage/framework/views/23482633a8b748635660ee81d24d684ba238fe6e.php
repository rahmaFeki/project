...
<head>
    ...
    <link rel="stylesheet" href=<?php echo e(asset("assetsFront/css/aos.css")); ?>>
    <link rel="stylesheet" href=<?php echo e(asset("assetsFront/css/bootstrap.min.css")); ?>>
    <link rel="stylesheet" href=<?php echo e(asset("assetsFront/css/imp.css")); ?>>
    <link rel="stylesheet" href=<?php echo e(asset("assetsFront/css/custom-animate.css")); ?>>
    <link rel="stylesheet" href=<?php echo e(asset("assetsFront/css/flaticon.css")); ?>>
    <link rel="stylesheet" href=<?php echo e(asset("assetsFront/css/font-awesome.min.css")); ?>>
    <link rel="stylesheet" href=<?php echo e(asset("assetsFront/css/owl.css")); ?>>
    <link rel="stylesheet" href=<?php echo e(asset("assetsFront/css/magnific-popup.css")); ?>>
    <link rel="stylesheet" href=<?php echo e(asset("assetsFront/css/scrollbar.css")); ?>>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href=<?php echo e(asset("assetsFront/images/favicon/apple-touch-icon.png")); ?>>
    <link rel="icon" type="image/png" href=<?php echo e(asset("assetsFront/images/favicon/favicon-32x32.png")); ?> sizes="32x32">
    <link rel="icon" type="image/png" href=<?php echo e(asset("assetsFront/images/favicon/favicon-16x16.png")); ?> sizes="16x16">
                ...
                <div class="container">
                    <div class="outer-box clearfix">
                        <div class="header-left clearfix pull-left">
                            <div class="logo"><a href="index.html"><img src=<?php echo e(asset("assetsFront/images/logoMSM.png")); ?>
                        ...
                        <div class="header-right pull-right">
                            <div class="header-contact-info clearfix">
                                <ul class="clearfix">
                                    ...
                                    <?php $__currentLoopData = $telephone; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
   
   
   <div class="icon"><span class="flaticon-incoming-call clr1"></span></div>
                                        <div class="text">
                                            <p><?php echo e($sections[0]); ?></p>
                                            <h4><a href="tel:123456789"><?php echo e($prop->num); ?></a></h4>
                                        </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="text col-3">
                                            <?php if(isset($entrep->email)): ?>
                                            <p><?php echo e($sections[1]); ?></p>
                                            <h4><?php echo e($entrep->email); ?> </h4>
                                            <?php endif; ?>
                                        </div>
                                    </li>
                                ...
                                <nav class="main-menu style1 navbar-expand-md navbar-light">
                                    <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                        <ul class="navigation clearfix">
                                            ...
                                            <li><a href="#sommes"><?php echo e($sections[2]); ?></a>
                                            ...
                                            <li><a href="#galler"><?php echo e($sections[6]); ?></a>

                                            <li class="dropdown"><a href="<?php echo e(route('page.index',$langCode)); ?>"> <img
                                                        src="<?php echo e(asset("assetsFront/images/$langCode.png")); ?>"
                                                        height="20px" width="20px" />
                                                    <?php echo e($lang); ?></a>
                                                <ul>
                                                    <li ><a href="<?php echo e(route('page.index',1)); ?>"> <img
                                                                src="<?php echo e(asset("assetsFront/images/1.png")); ?>"
                                                                height="20px" width="20px" />
                                                            FR</a>
                                                    <li><a href="<?php echo e(route('page.index',2)); ?>"><img
                                                                src="<?php echo e(asset("assetsFront/images/2.png")); ?>"
                                                                height="20px" width="20px" />
                                                            EN</a></li>
            ...
            <div class="mobile-menu">
                ...
                <nav class="menu-box">
                    <div class="nav-logo"><a href="index.html"><img src=<?php echo e(asset("assetsFront/images/logoMSM.png")); ?>
                    ...
                    <div class="slide">
                        ...
                        <div class="auto-container">
                            <div class="content text-center">
                                <h3><?php echo e($intit1); ?></h3>
                                <div class="big-title">
                                    <h2><?php echo e($intit2); ?><br><?php echo e($intit3); ?></h2>
                                </div>
        ...
        <section class="features-style1-area" id="service">
            <div class="container">
                ...
                <div class="row">
                    <?php $__currentLoopData = $missions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="single-features-style1 wow fadeInUp" data-wow-delay="00ms"
                            ...
                            <div class="inner">
                                ...
                                <div class="title-holder">
                                    <h3><a href="#"><?php echo e($u->lib); ?></a></h3>
                                </div>
                            </div><!-- /.inner -->
                    ...
                    <div class="col-xl-12">
                        <div class="about-style1-content-box text-right-rtl">
                            ...
                            <div class="inner-content">
                                <div class="top_text">
                                    <p><?php if($langCode==1): ?>Une Longue Expérience Dans Le Domaine De L'industrie.
                                        <?php else: ?>
        ...
        <?php $__currentLoopData = $sectionNew; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="single-service-style2">
                            ...
                            <div class="inner_box">
                                ...
                                <div class="text-holder">
                                    <h3><a href="#"><?php echo e($u->title); ?></a></h3>
                                    <p><?php echo e($u->description); ?></p>
                    ...
                    <div class="col-xl-12">
                        <div class="project-style1_content">
                            <div class="project-style1_carousel three-item-carousel owl-carousel owl-theme">
                                ...
                                <?php $__currentLoopData = $gallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="single-footer-widget marbtm wow animated fadeInUp" data-wow-delay="0.1s">
                                    <div class="our-company-info">
                                        <div class="footer-logo"><img
                                                    src=<?php echo e(asset("assetsFront/images/logoMSM.png")); ?> alt="Footer Logo"
                                                    title="Logo"></div>
                                        <div class="text-box">
                                            <p><?php echo e($contenu); ?></p>
                                        </div>
                                        ...
                                        <div class="single-footer-widget">
                                            ...
                                            <div class="footer-contact-info">
                                                <ul>
                                                    ...
                                                    <li>
                                                    <?php $__currentLoopData = $telephone; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if($u!=null): ?>
                                                        <div class="icon"><span
                                                                ...
                                                                <div class="text">
                                                            <p class="large"><a ><?php echo e($u->num); ?></a></p>
                                                        </div>
                                                        <?php endif; ?>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <?php if(isset($entrep->adr)): ?>
                                                    <li>
                                                        <div class="icon"><span
                                                                class="flaticon-placeholder clr1"></span></div>
                                                        <div class="text">
                                                            <p><?php echo e($entrep->adr); ?></p>
                                                        </div>
                                                    </li>
                                                  <?php endif; ?>
                                                    <?php if(isset($entrep->adr)): ?>
                                                    <li>
                                                        ...
                                                        <div class="text">
                                                            <p><a href="mailto:logistic@email.com"><?php echo e($entrep->email); ?></a>
                                                            </p>
                                                        </div>
                                                    </li>
                                                    <?php endif; ?>
    ...
    <script src=<?php echo e(asset("assetsFront/js/jquery.js")); ?>></script>
    <script src=<?php echo e(asset("assetsFront/js/aos.js")); ?>></script>
    <script src=<?php echo e(asset("assetsFront/js/appear.js")); ?>></script>
    <script src=<?php echo e(asset("assetsFront/js/bootstrap.bundle.min.js")); ?>></script>
    <script src=<?php echo e(asset("assetsFront/js/bootstrap-select.min.js")); ?>></script>
    <script src=<?php echo e(asset("assetsFront/js/isotope.js")); ?>></script>
    <script src=<?php echo e(asset("assetsFront/js/jquery.bxslider.min.js")); ?>></script>
    <script src=<?php echo e(asset("assetsFront/js/jquery.countdown.min.js")); ?>></script>
    <script src=<?php echo e(asset("assetsFront/js/jquery.countTo.js")); ?>></script>
    <script src=<?php echo e(asset("assetsFront/js/jquery.easing.min.js")); ?>></script>
    <script src=<?php echo e(asset("assetsFront/js/jquery.enllax.min.js")); ?>></script>
    <script src=<?php echo e(asset("assetsFront/js/jquery.fancybox.js")); ?>></script>
    <script src=<?php echo e(asset("assetsFront/js/jquery.magnific-popup.min.js")); ?>></script>
    <script src=<?php echo e(asset("assetsFront/js/jquery.paroller.min.js")); ?>></script>
    <script src=<?php echo e(asset("assetsFront/js/jquery.polyglot.language.switcher.js")); ?>></script>
    <script src=<?php echo e(asset("assetsFront/js/jQuery.style.switcher.min.js")); ?>></script>
    <script src=<?php echo e(asset("assetsFront/js/jquery-ui.js")); ?>></script>
    <script src=<?php echo e(asset("assetsFront/js/knob.js")); ?>></script>
    <script src=<?php echo e(asset("assetsFront/js/map-script.js")); ?>></script>
    <script src=<?php echo e(asset("assetsFront/js/owl.js")); ?>></script>
    <script src=<?php echo e(asset("assetsFront/js/pagenav.js")); ?>></script>
    <script src=<?php echo e(asset("assetsFront/js/parallax.min.js")); ?>></script>
    <script src=<?php echo e(asset("assetsFront/js/scrollbar.js")); ?>></script>
    <script src=<?php echo e(asset("assetsFront/js/slick.js")); ?>></script>
    <script src=<?php echo e(asset("assetsFront/js/timePicker.js")); ?>></script>
    <script src=<?php echo e(asset("assetsFront/js/validation.js")); ?>></script>
    <script src=<?php echo e(asset("assetsFront/js/wow.js")); ?>></script>
    <script src=<?php echo e(asset("assetsFront/js/TweenMax.min.js")); ?>></script><!-- thm custom script -->
    <script src=<?php echo e(asset("assetsFront/js/custom.js")); ?>></script>
</body>
...
</html><?php /**PATH C:\xampp1\htdocs\msm\resources\views/welcome.blade.php ENDPATH**/ ?>